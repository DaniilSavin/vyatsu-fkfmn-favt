...
namespace lab3
{
    public partial class Form1 : Form
    {
        ...
        private void BegintoolStrip_Click(object sender, EventArgs e)
        {
            try
            {
                Stream myStream;
                ...
                if (K > 2)
                {
                    ...
                    graph.DrawLine(myPen, X0 + 25, Y0 - 25, pictureBox2.Width - 50, 50);
                    x = (pictureBox2.Width - 50) / 20;
                    y = (pictureBox2.Height - 50) / 20;
                    float zx = (pictureBox2.Width - 100) / 20;
                    float zy = (pictureBox2.Height - 100) / 20;
                    Y = Y0;
                    X = X0;
                    float ZX = Z0X;
                    float ZY = Z0Y;
                    for (int i = 0; i <= 20; i++)
                    {
                        ...
                        if (i != 10)
                            graph.DrawString((Math.Round(maxCoordinate[1] / 10, 2) * (i - 10)).ToString(), Font, Brushes.Black, (pictureBox2.Width) / 2 - 25, (float)(Y - 5));
                        if (i != 10 && K > 2)
                        {
                    ...
                    graph.DrawString("y", Font, Brushes.Black, (pictureBox2.Width) / 2 - 15, (float)(Y + 5));
                    ...
                    graph.DrawLine(myPen, (pictureBox2.Width) / 2 + 5, 30, (pictureBox2.Width) / 2, 20);
                    graph.DrawLine(myPen, (pictureBox2.Width) - 50, 50, (pictureBox2.Width) - 50, 60);
                    graph.DrawLine(myPen, (pictureBox2.Width) - 50, 50, (pictureBox2.Width) - 60, 50);

                    for (int i = 0; i < N; i++)
                    {
                        graph.FillEllipse(new SolidBrush(colors[i]), (pictureBox2.Width) / 2 + (float)((coordinateValues[0][i, 0] / maxCoordinate[0] - coordinateValues[i][i, 2] / maxCoordinate[2] / 2) * (pictureBox2.Width / 2 - 25)) - 3, (Y0 + 25) / 2 - (float)((coordinateValues[0][i, 1] / maxCoordinate[1] + coordinateValues[i][i, 2] / maxCoordinate[2] / 2) * (pictureBox2.Height / 2 - 25)) - 3, 6, 6);
                    }
                    for (int i = 0; i < coordinateValues.Count - 1; i++)
                    {
                        for (int n = N - 1; n > -1; n--)
                        {
                            ...
                            graph.DrawLine(myPens1[n], (pictureBox2.Width) / 2 + (float)((coordinateValues[i][n, 0] / maxCoordinate[0] - coordinateValues[i][n, 2] / maxCoordinate[2] / 2) * (pictureBox2.Width / 2 - 25)), (Y0 + 25) / 2 - (float)((coordinateValues[i][n, 1] / maxCoordinate[1] + coordinateValues[i][n, 2] / maxCoordinate[2] / 2) * (pictureBox2.Height / 2 - 25)),
                                (pictureBox2.Width) / 2 + (float)((coordinateValues[i + 1][n, 0] / maxCoordinate[0] - coordinateValues[i + 1][n, 2] / maxCoordinate[2] / 2) * (pictureBox2.Width / 2 - 25)), (Y0 + 25) / 2 - (float)((coordinateValues[i + 1][n, 1] / maxCoordinate[1] + coordinateValues[i][n, 2] / maxCoordinate[2] / 2) * (pictureBox2.Height / 2 - 25)));
                        }
                    }
                }
                else MessageBox.Show("zxc");
