...
import com.example.voiceassistant.Database.DBHelper;
import com.example.voiceassistant.Database.MessageEntity;
import com.example.voiceassistant.MessageService.Message;
import com.example.voiceassistant.MessageService.MessageListAdapter;
        ...
        AI.getAnswer(text, s -> {
            ...
            if (s.contains("https"))
            {
                new AsyncTask<String, Integer, Void>() {
                    ...
                    public void execute(boolean add) {
                    }
...
/*    @SuppressLint("NewApi")
   ...
   /* @SuppressLint("NewApi")
    ...
    protected void onSend() throws IOException, ParseException {
        String text = questionText.getText().toString();
